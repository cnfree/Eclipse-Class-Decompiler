...
public class ContextUnit
{
	...
	private final List<String> classEntries = new ArrayList<String>( ); // class
																		// file
																		// or
																		// jar/zip
																		// entry
	...
	public ContextUnit( int type, String archivePath, String filename, boolean own, IResultSaver resultSaver,
