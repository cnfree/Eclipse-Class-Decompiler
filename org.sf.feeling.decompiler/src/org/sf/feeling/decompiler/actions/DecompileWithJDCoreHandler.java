...
public class DecompileWithJDCoreHandler extends DecompileHandler
{
	...
	public Object execute( ExecutionEvent event ) throws ExecutionException
	{
		...
		if ( classes != null && !classes.isEmpty( ) )
		{
			...
			new OpenClassesAction( editor, classes, DecompilerType.JDCORE ).run( );
		}
		else
		{
			...
			{
				if ( editor != null )
					editor.doSetInput( DecompilerType.JDCORE, true );
			}
		}
		return null;
	}
