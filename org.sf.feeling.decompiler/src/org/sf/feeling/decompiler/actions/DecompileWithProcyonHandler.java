...
public class DecompileWithProcyonHandler extends DecompileHandler
{
	...
	public Object execute( ExecutionEvent event ) throws ExecutionException
	{
		...
		if ( classes != null && !classes.isEmpty( ) )
		{
			...
			new OpenClassesAction( editor, classes, DecompilerType.PROCYON ).run( );
		}
		else
		{
			...
			{
				if ( editor != null )
					editor.doSetInput( DecompilerType.PROCYON, true );
			}
		}
		return null;
	}
