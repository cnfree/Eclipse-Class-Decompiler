...
public class JavaDecompilerPreferencePage extends FieldEditorPreferencePage
	...
	protected void createFieldEditors() {
		StringChoiceFieldEditor defaultDecompiler = new StringChoiceFieldEditor(
				"net.sf.feeling.decompiler.type",
		...
		this.basicGroup
				.setText(Messages
						.getString("JavaDecompilerPreferencePage.Label.DecompilerSettings"));
		...
		BooleanFieldEditor showReport = new BooleanFieldEditor(
				"jd.ide.eclipse.prefs.DisplayMetadata",
		...
		this.formatGroup
				.setText(Messages
						.getString("JavaDecompilerPreferencePage.Label.FormatSettings"));
		gd = new GridData(768);
		gd.horizontalSpan = defaultDecompiler.getNumberOfControls();
		this.formatGroup.setLayoutData(gd);

		this.eclipseFormatter = new CheckFieldEditor(
				"net.sf.feeling.decompiler.use_eclipse_formatter",
				Messages.getString("JavaDecompilerPreferencePage.Label.UseEclipseFormat.Jad"),
				this.formatGroup);
		addField(this.eclipseFormatter);

		this.eclipseSorter = new CheckFieldEditor(
				"net.sf.feeling.decompiler.use_eclipse_sorter",
		...
		this.debugGroup.setText(Messages
				.getString("JavaDecompilerPreferencePage.Label.DebugSettings"));
		gd = new GridData(768);
		gd.horizontalSpan = defaultDecompiler.getNumberOfControls();
		this.debugGroup.setLayoutData(gd);

		this.optionLncEditor = new CheckFieldEditor(
				"jd.ide.eclipse.prefs.DisplayLineNumbers",
				Messages.getString("JavaDecompilerPreferencePage.Label.OutputLineNumber"),
				this.debugGroup);
		addField(this.optionLncEditor);

		this.alignEditor = new CheckFieldEditor(
				"jd.ide.eclipse.prefs.Align",
		...
		startupGroup.setText(Messages
				.getString("JavaDecompilerPreferencePage.Label.Startup"));
		gd = new GridData(768);
		gd.horizontalSpan = defaultDecompiler.getNumberOfControls();
		startupGroup.setLayoutData(gd);

		CheckFieldEditor defaultViewerEditor = new CheckFieldEditor(
				"net.sf.feeling.decompiler.default_editor",
	...
	protected void performDefaults() {
		...
		boolean enabled = Boolean.valueOf(
				this.optionLncEditor.getBooleanValue()).equals(Boolean.TRUE);
		this.alignEditor.setEnabled(enabled, this.debugGroup);
	}
	...
	class CheckFieldEditor extends BooleanFieldEditor {
		...
		protected void fireStateChanged(String property, boolean oldValue,
			...
			fireValueChanged(property, (oldValue) ? Boolean.TRUE
					: Boolean.FALSE, (newValue) ? Boolean.TRUE : Boolean.FALSE);
		}
